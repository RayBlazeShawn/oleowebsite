                    ...
                    <div class="row">
                        <div class="col-12 col-xxl-6 col-lg-8 col-sm-10">
                            <div class="hero-contents pe-lg-3 text-white">
                                <h1 style="color: black"; style class="fs-lg animated" data-animation-in="fadeInRight" data-delay-in="0.2" style="color: black";> Oleodinamica 
                                     <span>
                                         Idraulica
                                        </span></h1>
    ...
    <section class="about-us-wrapper section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 mt-8 mt-lg-0 ps-lg-8">
                    <div class="block-contents">
                        <div class="section-title">
                            <h5 class="textleft relative">about</h5>
                            <h2 style="color: black";>ABOUT  <span>COMPANY</span></h2>
                        </div>
                    </div>
...
Oleodinamica Idraulica
 ...
 is the world’s driving worldwide coordinations supplier — we uphold industry and exchange the worldwide trade of merchandise through land transport.
Oleodinamica Idraulica
 ...
 is the world’s driving worldwide coordinations supplier — we uphold industry and exchange the worldwide trade of merchandise through land transport.
    ...
    <section class="our-team-wrapper section-padding">
        <div class="container">
                ...
                <div class="col-md-8">
                    <div class="block-contents mb-20">
                        <div class="section-title">
                            ...
                            <h2 style="color: black";>Manufacturing <span>Facility</span></h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-md-9 col-50">
            ...
            <div class="col-md-12 col-12">
                <div class="services-carousel-active">
                    ...
                    <div class="single-service-card">
                        ...
                        <div class="content">
                            <h3><a href="services-details.html">Description</a></h3>
                            <p>......................................</p>
                        </div>
                    </div>
                    <div class="single-service-card">
